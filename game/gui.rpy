...
## Оператор "init offset" змушує оператори ініціалізації у цьому файлі виконуватися перед операторами "init" в будь-якому іншому файлі.
init offset = -2

## При виклику "gui.init" стилі відновлюються до розумних стандартних значень, а також встановлюються ширина і висота гри.
init python:
    gui.init(1920, 1080)

## Увімкнути перевірку на наявність недійсних або нестабільних властивостей в екранах або трансформаціях
...
## Малий колір використовується для маленького тексту, який має бути яскравішим/темнішим для досягнення того самого ефекту.
...
## Колір текстової кнопки, коли її вибрано, але не сфокосовано. 
## Кнопку вибрано, якщо вона на поточному екрані або значенням налаштування.
...
## Кольори частин смуг, які не заповнені. 
## Вони не використовуються безпосередньо, але застосовуються під час повторного створення файлів зображень смуг.
...
##Зображення, використане для завнтаження, збереження, історії й пункта про гру
define gui.about_save_load_background = "gui/bg_about_load_save.png"


## Зображення, використані для навігації
...
## Розташування текстового поля по вертикалі на екрані. 0,0 — верх, 0,5 — центр, 1,0 — низ.
define gui.textbox_yalign = 1.0


## Розташування імені персонажа, відносно текстового поля. 
## Значення може бути цілим числом пікселів від лівого краю або верхнього краю, або 0,5 до центру.
define gui.name_xpos = 360
define gui.name_ypos = 0


## Горизонтальне вирівнювання імені персонажа. 
## Значення може бути 0,0 для вирівнювання по лівому краю, 0,5 по центру і 1,0 по правому краю.
define gui.name_xalign = 0.0


## Ширина, висота та межі поля, що містить ім’я персонажа, або None для автоматичного визначення розміру.
...
## Якщо задано "True", тло поля імені буде мозаїчним.
## Якщо задано "False", тло поля імені буде масштабованим.
define gui.namebox_tile = False


## Розташування діалогу відносно текстового поля.
## Значення може бути цілим числом пікселів відносно лівого або верхнього краю текстового поля, або 0,5 для вирівнювання по центру.
...
## Горизонтальне вирівнювання тексту діалогу.
## Значення може бути 0,0 для вирівнювання по лівому краю, 0,5 по центру і 1,0 по правому краю.
...
## Ширина та висота кнопки у пікселях. 
## Якщо задано "None", Ren'Py обчислюватиме розмір.
...
## Горизонтальне вирівнювання тексту кнопки. (0,0 — ліворуч, 0,5 — по центру, 1,0 — праворуч).
define gui.button_text_xalign = 0.0


## Ці змінні замінюють налаштування для різних типів кнопок. 
## Дивіться документацію по GUI, щоб дізнатися про типи доступних кнопок та їх призначення.
##
...
## Наприклад, ви можете розкоментувати наступний рядок, щоб задати ширину кнопки навігації.
...
##
## Кнопка комірки збереження — особливий вид кнопки. 
## Вона містить мініатюру і текст, що описує уміст комірки збереження.
## Комірка збереження використовує файли зображень у "gui/button", як і інші типи кнопок.
...
## Рамки #######################################################################
##
## Ці змінні визначають вигляд рамок, які можуть містити компоненти інтерфейсу, коли накладення або вікно відсутні.
...
##
## Стандартний інтерфейс використовує лише повзунки та вертикальні смуги прокрутки.
## Усі інші смуги використовуються лише на екранах, написаних автором.



## Висота горизонтальних смуг, смуг прокруток і повзунків. 
## Ширина вертикальних смуг, смуг прокруток і повзунків.
define gui.bar_size = 38
define gui.scrollbar_size = 18
define gui.slider_size = 38


## True, якщо зображення смуги мають бути викладено плиткою. 
## False, якщо вони повинні бути лінійно масштабовані.
...
## Що робити з не прокручуваними смугами прокрутки у меню гри. 
## Параметр "hide" приховує їх, а "None" показує їх.
...
## Максимальна кількість рядків у режимі NVL, які Ren'Py покаже. 
## Якщо потрібно показати більше рядків, найстаріший рядок буде видалено.
define gui.nvl_list_length = 6


## Висота рядку в режимі NVL.
## Задайте значення "None", щоб рядки динамічно регулювали висоту.
define gui.nvl_height = 173


## Відстань між рядками режиму NVL, коли "gui.nvl_height" має значення "None", та між рядками режиму NVL і меню режиму NVL.
...
##  Позиція, ширина та вирівнювання тексту "nvl_thought" (текст, який вимовляє персонаж "nvl_narrator").
...
## Визначає, де дозволений розрив рядка. 
## Стандартне значення підходить для більшості мов.
## Список доступних значень можна знайти на https://www.renpy.org/doc/html/style_properties.html#style-property-language
